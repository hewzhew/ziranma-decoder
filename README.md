...
下一次算法扩展应把当前有界 beam 与小型人工语言模型升级成可测量的
k-shortest lattice 搜索，并加入明确受罚的词典外回退。随后换入更大的
公开词典和有明确许可证的独立公开语料，再做真实性更高的词外输入、
长句、内存和延迟评测。
