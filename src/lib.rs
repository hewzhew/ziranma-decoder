...
pub use wish_feedback::{
    ...
    WishCategory, WishEventRole, WishFeedbackError, WishJournalAnchor, WishJournalContext,
    WishJournalSpan, WishNote, WishPackageInfo, WishRuntimeIdentity, WishSaveReceipt, WishSnapshot,
    list_wish_packages, load_wish_note, load_wish_snapshot, move_wish_to_trash,
    save_or_replace_wish_note, save_wish_note, save_wish_snapshot,
};
