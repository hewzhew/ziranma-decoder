...
pub use wish_feedback::{
    ...
    WISH_SCHEMA_V19, WISH_SCHEMA_V20, WISH_SCHEMA_V21, WISH_SCHEMA_V22, WishCaptureScope,
    WishCategory, WishEventRole, WishFeedbackError, WishImportance, WishJournalAnchor,
    WishJournalContext, WishJournalSpan, WishNote, WishNoteFileVersion, WishPackageInfo,
