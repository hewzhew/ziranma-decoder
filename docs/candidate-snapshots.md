...
第 1 项，漏掉了两个真实的第 2 项分支。全目录离线审计耗时 70,735.689 ms；独立的
16 码 × 5 次性能抽样中，两层查询 median/p95 为 12.086/15.661 ms，三包预览为
11.610/16.840 ms。这些差异只视作同机噪声，不声称新层更快；70 秒全量离线扫描也
不是日常按键热路径。该门仍没有创建真实 Context、候选窗或桌面帧，因此它本身不能
替代 TSF 三层宿主预检，也不构成启用许可。
